...
<style>
    ...
    input[type="number"]::-webkit-outer-spin-button{
        ...
        <div class="card" style="width: 85rem; height: 20rem;">
            <div class="card-body d-flex gap-4">
                <img src="{{asset('assets/image/contoh.png')}}" alt="" style="width: 300px">
                <div class="desc w-100">
                    ...
                    <div class="row mb-2">
                       ...
                       <div class="col-sm-5 d-flex">
                        ...
                        <input type="number" name="qty" class="form-control w-25 text-center" id="qty" min="0"
                        max="9999" value="1">
